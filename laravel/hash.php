...
class Hash
{
     ...
     * of
     * "rounds" to be increased, thus increasing the time it takes to generate
     * the
    ...
    {
        return crypt($value, 
                '$2a$' . str_pad($rounds, 2, '0', STR_PAD_LEFT) . '$' .
                         static::salt());
    }
    ...
    protected static function salt ()
    {
        ...
        // data
        // and replace them with dots. OpenSSL will be used if available, since
        // it is
        ...
        return substr(str_replace('+', '.', base64_encode(Str::random(40))), 0, 
                22);
    }
