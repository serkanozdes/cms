...
class File
{
     ...
     *
     * // Get the contents of a file or return a default value if it doesn't
     * exist
    ...
    public static function is ($extensions, $path)
    {
        ...
        foreach ((array) $extensions as $extension) {
            ...
            if (isset($mimes[$extension]) and
                     in_array($mime, (array) $mimes[$extension])) {
                        return true;
                    }
                }
