...
class Auth
{
     ...
     *
     * If no user exists in the session, the method will check for a "remember
     * me"
    ...
    protected static function recall ($recaller)
    {
        ...
        // the
        // user's ID and a long, random string. The ID and string are separated
        // by
     ...
     *
     * If the credentials are valid, the user will be logged into the
     * application
     * and their user ID will be stored in the session via the "login" method.
     *
     * The user may also be "remembered", which will keep the user logged into
     * the
     ...
     *
     * An object representing the user or an integer user ID may be given to the
     * method.
     * If an object is given, the object must have an "id" property containing
     * the user
