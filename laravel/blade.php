...
class Blade
{
     ...
     * @var array
     */
    protected static $compilers = array('echos', 'structure_openings', 
            'structure_closings', 'else', 'yields', 'section_start', 
            'section_end');
     ...
     *
     * Blade echo statements are simply PHP statement enclosed within double
     * curly
     * braces. For example, {{$content}} will simply echo out the content
     * variable
     ...
     *
     * By "structures", we mean the if, elseif, foreach, for, and while
     * statements.
     * All of these structures essentially have the same format, and can be
     * lumped
    ...
    protected static function compile_yields ($value)
    {
        ...
        return preg_replace($pattern, 
                '$1<?php echo \\Laravel\\Section::yield$2; ?>', $value);
    }
    ...
    protected static function compile_section_start ($value)
    {
        ...
        return preg_replace($pattern, '$1<?php \\Laravel\\Section::start$2; ?>', 
                $value);
    }
    ...
    {
        return preg_replace('/@endsection/', 
                '<?php \\Laravel\\Section::stop(); ?>', $value);
    }
