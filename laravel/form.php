...
class Form
{
     ...
     *
     * These names are stored so that input elements can automatically be
     * assigned
     ...
     * Open a HTML form.
     *
     * If PUT or DELETE is specified as the form method, a hidden input field
     * will be generated
     * containing the request method. PUT and DELETE are not supported by HTML
     * forms, so the
     * hidden field will allow us to "spoof" PUT and DELETE requests.
     *
     * Unless specified, the "accept-charset" attribute will be set to the
     ...
     *
     * Since PUT and DELETE requests are spoofed using POST requests, we will
     * substitute
     * POST for any PUT or DELETE methods. Otherwise, the specified method will
     * be used.
     *
     * @param $method string           
     * @return string
     ...
     * @return string
     */
    public static function open_secure ($action = null, $method = 'POST', 
            $attributes = array())
    {
     ...
     * @return string
     */
    public static function open_for_files ($action = null, $method = 'POST', 
     ...
     * @return string
     */
    public static function open_secure_for_files ($action = null, $method = 'POST', 
            $attributes = array())
    {
    ...
    {
        return static::input('hidden', Session::csrf_token, 
                IoC::core('session')->token());
    }
    ...
    public static function label ($name, $value, $attributes = array())
    {
        ...
        return '<label for="' . $name . '"' . $attributes . '>' . $value .
                 '</label>' . PHP_EOL;
            }
             ...
             *
             * If an ID attribute is not specified and a label has been
             * generated matching the input
             ...
             * @return string
             */
            public static function telephone ($name, $value = null, 
                    $attributes = array())
            {
                    ...
                    $attributes = array())
            {
                ...
                return '<textarea' . HTML::attributes($attributes) . '>' .
                         HTML::entities($value) . '</textarea>' . PHP_EOL;
                    }
                     ...
                     * echo Form::select('sizes', array('S' => 'Small', 'L' =>
                     * 'Large'));
                     *
                            ...
                            $selected = null, $attributes = array())
                    {
                        ...
                        foreach ($options as $value => $display) {
                            $html[] = static::option($value, $display, 
                                    $selected);
                        }
                        
                        return '<select' . HTML::attributes($attributes) . '>' .
                                 implode('', $html) . '</select>' . PHP_EOL;
                            }
                             ...
                             * @return string
                             */
                            protected static function option ($value, $display, 
                                    $selected)
                            {
                                ...
                                return '<option' . HTML::attributes($attributes) .
                             ...
                             * @return string
                             */
                            public static function checkbox ($name, $value = 1, 
                                    $checked = false, $attributes = array())
                            {
                                return static::checkable('checkbox', $name, 
                             ...
                             *
                             * // Create a radio button that is selected by
                             * default
                                    ...
                                    $checked = false, $attributes = array())
                            {
                                ...
                                return static::checkable('radio', $name, $value, 
                                        $checked, $attributes);
                            }
                             ...
                             * @return string
                             */
                            protected static function checkable ($type, $name, 
                                    $value, $checked, $attributes)
                            {
                                if ($checked)
                                ...
                                return static::input($type, $name, $value, 
                                        $attributes);
                            }
                            ...
                            public static function submit ($value, 
                                    $attributes = array())
                            {
                                return static::input('submit', null, $value, 
                                        $attributes);
                            }
                            ...
                            public static function reset ($value, 
                                    $attributes = array())
                            {
                                return static::input('reset', null, $value, 
                                        $attributes);
                            }
                             ...
                             *
                             * The URL::to_asset method will be called on the
                             * given URL.
                             *
                             * <code>
                             ...
                             * @return string
                             */
                            public static function image ($url, $name = null, 
                                    $attributes = array())
                            {
                                $attributes['src'] = URL::to_asset($url);
                                
                                return static::input('image', $name, null, 
                                        $attributes);
                            }
                             ...
                             *
                             * An explicitly specified ID in the attributes
                             * takes first precedence, then
                             * the label names will be checked for a label
