...
class Response
{
     ...
     * @var array
     */
    protected $statuses = array(100 => 'Continue', 101 => 'Switching Protocols', 
     ...
     * return Respone::make(json_encode($user), 200, array('content-type' =>
     * 'application/json'));
     * </code>
     *
     * @param $content mixed           
     ...
     *
     * Note: The specified error should match a view in your views/error
     * directory.
     *
     * <code>
        ...
        $headers = array_merge(
                array('Content-Description' => 'File Transfer', 
                        ...
                        'Content-Disposition' => 'attachment; filename="' . $name .
                                ...
                                'Pragma' => 'public', 
                                'Content-Length' => File::size($path)), $headers);
     ...
     *
     * All of the response headers will be sent to the browser first, followed
     * by
     * the content of the response instance, which will be evaluated and
     * rendered
     ...
     * the headers set by the developer will be automatically sent to the
     * browser
    ...
    /**
     * Magic Method for handling the dynamic creation of Responses containing
     * named views.
     *
     * <code>
    ...
    public static function __callStatic ($method, $parameters)
    {
        if (strpos($method, 'of_') === 0) {
            return static::of(substr($method, 3), 
                    Arr::get($parameters, 0, array()));
        }
        throw new \BadMethodCallException(
                "Method [$method] is not defined on the Response class.");
    }
