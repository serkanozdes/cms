...
class Validator
{
    ...
    protected function check ($attribute, $rule)
    {
        ...
        if ($validatable and
                 ! $this->{'validate_' . $rule}($attribute, $value, $parameters, 
                        $this)) {
             ...
             *
             * To be considered validatable, the attribute must either exist, or
             * the
            ...
            {
                return $this->validate_required($attribute, $value) or
                         $this->implicit($rule);
                    }

                    /**
                     * Determine if a given rule implies that the attribute is
                     * required.
                     *
                     * @param $rule string           
                     * @return bool
                    ...
                    /**
                     * Add an error message to the validator's collection of
                     * messages.
                     *
                     * @param $attribute string           
                     * @param $rule string           
                    ...
                    protected function error ($attribute, $rule, $parameters)
                    {
                        ...
                        $message = $this->replace($message, $attribute, $rule, 
                                $parameters);
                    ...
                    /**
                     * Validate that a required attribute exists in the
                     * attributes array.
                     *
                     * @param $attribute string           
                     * @param $value mixed           
                    ...
                    protected function validate_required ($attribute, $value)
                    {
                        if (is_null($value)) {
                            ...
                            return false;
                        } elseif (! is_null(Input::file($attribute)) and
                                 $value['tmp_name'] == '') {
                                    return false;
                                }
                                    ...
                                    $value)
                            {
                                ...
                                return isset($this->attributes[$confirmed]) and
                                     ...
                                     * "accepted".
                                     *
                                     * This validation rule implies the
                                     ...
                                     * @return bool
                                     */
                                    protected function validate_accepted (
                                            $attribute, $value)
                                    {
                                     ...
                                     * @return bool
                                     */
                                    protected function validate_numeric (
                                            $attribute, $value)
                                    {
                                     ...
                                     * @return bool
                                     */
                                    protected function validate_integer (
                                            $attribute, $value)
                                    {
                                     ...
                                     * @return bool
                                     */
                                    protected function validate_size ($attribute, 
                                            $value, $parameters)
                                    {
                                        return $this->size($attribute, $value) ==
                                                 $parameters[0];
                                            }

                                            /**
                                             * Validate the size of an attribute
                                             * is between a set of values.
                                             *
                                             * @param $attribute string           
                                             * @param $value mixed           
                                             * @param $parameters array           
                                            ...
                                            protected function validate_between (
                                                    ...
                                                    $parameters)
                                            {
                                                $size = $this->size($attribute, 
                                                        $value);
                                                
                                                return $size >= $parameters[0] and
                                                         $size <= $parameters[1];
                                                    }

                                                    /**
                                                     * Validate the size of an
                                                                        ...
                                                                        if (is_numeric(
                                                                                $value) and
                                                                                 $this->has_rule(
                                                                                     ...
                                                                                     * @return bool
                                                                                     */
                                                                                    protected function validate_in (
                                                                                            $attribute, 
                                                                                            $value, 
                                                                                            $parameters)
                                                                                    {
                                                                                     ...
                                                                                     * @return bool
                                                                                     */
                                                                                    protected function validate_not_in (
                                                                                            $attribute, 
                                                                                            $value, 
                                                                                            $parameters)
                                                                                    {
                                                                                     ...
                                                                                     * @return bool
                                                                                     */
                                                                                    protected function validate_unique (
                                                                                            $attribute, 
                                                                                            $value, 
                                                                                            $parameters)
                                                                                    {
                                                                                                ...
                                                                                                return filter_var(
                                                                                                            ...
                                                                                                            $value)
                                                                                                    {
                                                                                                        return filter_var(
                                                                                                             ...
                                                                                                             * @return bool
                                                                                                             */
                                                                                                            protected function validate_active_url (
                                                                                                                    $attribute, 
                                                                                                                    $value)
                                                                                                            {
                                                                                                                $url = str_replace(
                                                                                                             ...
                                                                                                             * @return bool
                                                                                                             */
                                                                                                            protected function validate_alpha (
                                                                                                                    $attribute, 
                                                                                                                    $value)
                                                                                                            {
                                                                                                                return preg_match(
                                                                                                             ...
                                                                                                             * @return bool
                                                                                                             */
                                                                                                            protected function validate_alpha_num (
                                                                                                                    $attribute, 
                                                                                                                    $value)
                                                                                                            {
                                                                                                                return preg_match(
                                                                                                             ...
                                                                                                             * @return bool
                                                                                                             */
                                                                                                            protected function validate_alpha_dash (
                                                                                                                    $attribute, 
                                                                                                                    $value)
                                                                                                            {
                                                                                                                return preg_match(
                                                                                                             ...
                                                                                                             * @return bool
                                                                                                             */
                                                                                                            protected function validate_mimes (
                                                                                                                    $attribute, 
                                                                                                                    $value, 
                                                                                                                    $parameters)
                                                                                                            {
                                                                                                        ...
                                                                                                        elseif (in_array(
                                                                                                            ...
                                                                                                            if ($this->has_rule(
                                                                                                                ...
                                                                                                                $line = (array_key_exists(
                                                                                                                        $attribute, 
                                                                                                                        Input::file())) ? 'file' : 'string';
                                                                                                            }
                                                                                                            
                                                                                                            return Lang::line(
                                                                                                                    "validation.{$rule}.{$line}")->get(
                                                                                                                    $this->language);
                                                                                                        }                                                                                                         
                                                                                                            ...
                                                                                                            $parameters)
                                                                                                    {
                                                                                                        ...
                                                                                                        if (in_array(
                                                                                                            ...
                                                                                                            // parameter.
                                                                                                            $max = ($rule ==
                                                                                                                     'between') ? $parameters[1] : $parameters[0];
                                                                                                             ...
                                                                                                             * @return bool
                                                                                                             */
                                                                                                            protected function has_rule (
                                                                                                                    $attribute, 
                                                                                                                    $rules)
                                                                                                            {
                                                                                                                foreach ($this->rules[$attribute] as $rule) {
                                                                                                                    list ($rule, $parameters) = $this->parse(
                                                                                                                            $rule);
                                                                                                            ...
                                                                                                            public function connection (
                                                                                                                    \Laravel\Database\Connection $connection)
                                                                                                            {
                                                                                                                $this->db = $connection;
                                                                                                                return $this;
                                                                                                            }
                                                                                                                    ...
                                                                                                                    $parameters)
                                                                                                            {
                                                                                                                ...
                                                                                                                // prefix.
                                                                                                                if (isset(
                                                                                                                        static::$validators[$method = substr(
                                                                                                                                $method, 
                                                                                                                                9)])) {
                                                                                                                    return call_user_func_array(
                                                                                                                            static::$validators[$method], 
                                                                                                                            $parameters);
                                                                                                                }
                                                                                                                
                                                                                                                throw new \BadMethodCallException(
                                                                                                                        "Call to undefined method [$method] on Validator instance.");
                                                                                                            }
