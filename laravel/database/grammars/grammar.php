...
namespace Laravel\Database\Grammars;
...
class Grammar
{
     ...
     * @var array
     */
    protected $components = array('aggregate', 'selects', 'from', 'joins', 
     ...
     * specified
     * in the "components" property. The entire query is passed into each
     * component
    ...
    protected function joins (Query $query)
    {
        ...
        foreach ($query->joins as $join) {
            ...
            $sql[] = sprintf($format, $join['type'], $table, $column1, 
                    $join['operator'], $column2);
        }
            ...
            protected function where_in ($where)
            {
                ...
                return $this->wrap($where['column']) . ' IN (' . $parameters .
                    ...
                    protected function where_not_in ($where)
                    {
                        ...
                        return $this->wrap($where['column']) . ' NOT IN (' .
                                 $parameters . ')';
                            }
                                        ...
                                        foreach ($query->orderings as $ordering) {
                                            $sql[] = $this->wrap(
                                                ...
                                                return 'ORDER BY ' .
                                                    ...
                                                    /**
                                                     * Compile a SQL DELETE
                                                     * statment from a Query
                                                     * instance.
                                                     *
                                                     * @param $query Query           
                                                     * @return string
                                            ...
                                            /**
                                             * The following functions primarily
                                             * serve as utility functions for
                                             * the grammar.
                                             * They perform tasks such as
                                             * wrapping values in keyword
                                             * identifiers or creating variable
                                             * lists of bindings.
                                             */
                                            
                                            /**
                                             * Create a comma-delimited list of
                                             * wrapped column names.
                                             *
                                             * @param $columns array           
                                             * @return string
                                             */
                                            final public function columnize (
                                                    $columns)
                                            {
                                                return implode(', ', 
                                                        array_map(
                                            ...
                                            /**
                                             * Wrap a value in keyword
                                             * identifiers.
                                             *
                                             * They keyword identifier used by
                                             * the method is specified as
                                             * a property on the grammar class
                                             * so it can be conveniently
                                             * overriden without changing the
                                             * wrapping logic itself.
                                             *
                                             * @param $value string           
                                             * @return string
                                             */
                                            ...
                                            {
                                                // If the value being wrapped
                                                // contains a column alias, we
                                                // need to wrap
                                                // it a little differently since
                                                // each segment must be wrapped
                                                // and not
                                                // the entire string.
                                                ...
                                                // injected into the query as
                                                // raw strings, so we
                                                // do not want to wrap them in
                                                // any way. We will just return
                                                // the string
                                                // value from the expression to
                                            ...
                                            /**
                                             * Create query parameters from an
                                             * array of values.
                                             *
                                             * @param $values array           
                                             * @return string
                                             ...
                                             * parameter string for a value.
                                             *
                                             * If the value is an expression,
                                             * the raw expression string should
                                             * be returned, otherwise, the
                                             * parameter place-holder will be
