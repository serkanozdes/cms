...
class Manager
{
        ...
        if (! isset(static::$connections[$connection])) {
            ...
            if (is_null($config)) {
                throw new \OutOfBoundsException(
                        "Connection is not defined for [$connection].");
            }
            
            static::$connections[$connection] = new Connection(
        ...
        switch ($driver) {
            ...
            default:
                throw new \DomainException(
                        "Database driver [$driver] is not supported.");
        }
    }
     ...
     *
     * This provides a convenient API for querying or examining the default
     * database connection.
     */
    public static function __callStatic ($method, $parameters)
    {
        return call_user_func_array(array(static::connection(), $method), 
                $parameters);
    }
