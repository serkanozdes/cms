...
class MySQL extends Connector
{
    ...
    public function connect ($config)
    {
        ...
        // Format the initial MySQL PDO connection string. These options are
        // required
        // for every MySQL connection that is established. The connection
        // strings
        // have the following convention: "mysql:host=hostname;dbname=database"
        $dsn = sprintf('%s:host=%s;dbname=%s', $driver, $host, $database);
        
        // Check for any optional MySQL PDO options. These options are not
        // required
