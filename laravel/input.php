...
class Input
{
     ...
     *
     * This method returns a merged array containing Input::get() and
     * Input::files().
     *
     * @return array
     */
     ...
     *
     * If the item is in the input array, but is an empty string, false will be
     * returned.
     *
     * @param $key string           
     * @return bool
     ...
     *
     * This method should be used for all request methods (GET, POST, PUT, and
     * DELETE).
     *
     * <code>
     ...
     *
     * The input data to be flashed may be controlled by using a filter and an
     * array
     * of included or excluded input data. This provides a convenient way of
     * keeping
    ...
    public static function flash ($filter = null, $items = array())
    {
        ...
        // Since the items flashed to the session can be filtered, we will
        // iterate
        // all of the input data and either remove or include the input item
        // based
