...
class Config
{
     ...
     *
     * // Determine if the "timezone" option exists in the "application"
     * configuration
    ...
    public static function get ($key, $default = null)
    {
        ...
        // If a specific configuration item was not requested, the key will be
        // null,
        // meaning we need to return the entire array of configuration item from
        // the
    ...
    public static function load ($file)
    {
        ...
        // Configuration files cascade. Typically, the system configuration
        // array is
        // loaded first, followed by the application array, providing the
        // convenient
        // cascading of configuration options from system to application.
        foreach (static::$paths as $directory) {
            if ($directory !== '' and file_exists($path = $directory . $file .
                     EXT)) {
